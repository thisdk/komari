...
use crate::{
    components::{icons::XIcon, use_controlled},
    // Aliased because `Key` is also the name of the Dioxus key enum used below.
    i18n::{Key as TextKey, use_i18n},
};
    ...
    rsx! {
        div { class: tw_merge!(DIV_CLASS, class),
            input {
                ...
                placeholder: i18n.t(TextKey::CommonClickToSet),
            ...
            if active() {
                div {
                    ...
                    {i18n.t(TextKey::CommonPressAnyKey)}
                }
            }
